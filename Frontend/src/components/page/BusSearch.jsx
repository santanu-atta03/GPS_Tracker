...
const PlaceSearch = ({ label, onSelect, enableUseMyLocation = false }) => {
  ...
  return (
    <div className="mb-6 relative">
      <label
        className={`block mb-3 font-semibold text-sm ${darktheme ? "text-gray-300" : "text-gray-700"
          }`}
      >
        {label}
      </label>
      ...
      {enableUseMyLocation && (
        <button
          type="button"
          className={`text-sm mt-3 font-semibold transition-all flex items-center gap-2 ${darktheme
      ...
      {selectedPos && (
        <div
          className={`mt-4 h-72 rounded-2xl overflow-hidden shadow-2xl border-2 ${darktheme ? "border-gray-700" : "border-gray-200"
            }`}
        >
          <MapContainer
...
const BusSearch = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <HeroSlider>
        <Navbar />
        <div className="max-w-5xl mx-auto px-4 py-12 relative z-10 w-full pt-32">
          {/* Hero Section */}
          <div className="text-center mb-12 animate-in fade-in zoom-in duration-1000 slide-in-from-bottom-10">
            <div className="inline-flex items-center gap-3 mb-6">
              <div className={`p-3 rounded-2xl backdrop-blur-md ${darktheme ? 'bg-blue-500/20 border border-blue-500/30' : 'bg-white/20 border border-white/30'}`}>
            ...
            <p
              className={`text-xl max-w-2xl mx-auto text-gray-100 font-medium drop-shadow-md`}
            >
          ...
          >
            <h2
              className={`text-2xl font-bold mb-8 text-center ${darktheme ? "text-white" : "text-gray-800"
                }`}
            >
            ...
            <div className="flex justify-center mb-8">
              <div
                className={`rounded-2xl p-2 transition-all duration-200 inline-flex flex-wrap gap-2 ${darktheme ? "bg-gray-900/50 border border-gray-700" : "bg-gray-100 border border-gray-200"
                  }`}
              >
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full mt-6">
                  <button
                    onClick={() => setSearchType("route")}
                    className={`px-6 py-3 rounded-xl transition-all duration-300 font-semibold flex items-center gap-2 ${searchType === "route"
                        ? darktheme
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-xl transition-all duration-300 font-semibold flex items-center gap-2 ${searchType === "device"
                        ? darktheme
                          ? "bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg"
                          : "bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg"
                        : darktheme
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-xl transition-all duration-300 font-semibold flex items-center gap-2 ${searchType === "name"
                        ? darktheme
                          ? "bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg"
                          : "bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg"
                        : darktheme
            ...
            {searchType === "device" && (
              <div className="max-w-md mx-auto">
                <label
                  className={`block text-sm font-semibold mb-3 ${darktheme ? "text-gray-300" : "text-gray-700"
                    }`}
                >
            ...
            <div className="text-center mt-8 space-y-4">
              <button
                ...
                className={`px-10 py-4 rounded-xl font-semibold transition-all duration-300 shadow-lg flex items-center gap-3 mx-auto ${canSearch() && !loading
                    ? darktheme
              ...
              {searchType === "route" && results && (
                <button
                  className={`px-10 py-4 rounded-xl font-semibold shadow-lg transition-all duration-300 flex items-center gap-3 mx-auto ${darktheme
          ...
          <div className="mt-8">
            {searchType === "route" && results ? (
              <>
                {results.type === "direct" && (
                  <div
                    className={`space-y-6 rounded-3xl shadow-2xl p-8 border backdrop-blur-sm ${darktheme
                        ? "bg-gray-800/80 border-gray-700/50"
                        : "bg-white/90 border-white/50"
                      }`}
                  >
                    <div className="flex flex-col items-center mb-6">
                      ...
                      <h2
                        className={`text-xl font-bold ${darktheme ? "text-green-400" : "text-green-700"
                          }`}
                      >
                        {t("busSearch.start")}
                      </h2>
                      <p
                        className={`text-sm mt-2 text-center max-w-md ${darktheme ? "text-gray-400" : "text-gray-600"
                          }`}
                      >
                        ...
                        >
                          {!isLast && (
                            <div className="flex items-center justify-center my-6">
                              <div className={`flex items-center gap-3 px-4 py-2 rounded-full ${darktheme ? 'bg-yellow-500/20 border border-yellow-500/30' : 'bg-yellow-100 border border-yellow-200'
                                }`}>
                          ...
                          <Card
                            className={`shadow-xl border-l-4 cursor-pointer transition-all duration-300 hover:scale-[1.02] ${darktheme
                            ...
                            <CardContent className="p-6">
                              <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                  <h3
                                    className={`font-bold text-lg mb-1 ${darktheme ? "text-white" : "text-gray-900"
                                      }`}
                                  >
                                    {t("busSearch.bus")} {bus.name}
                                  </h3>
                                  <p
                                    className={`text-sm mb-1 flex items-center gap-2 ${darktheme ? "text-gray-300" : "text-gray-600"
                                      }`}
                                  >
                                    <MapPin className="w-4 h-4" />
                                  ...
                                  <p
                                    className={`text-sm mb-1 flex items-center gap-2 ${darktheme ? "text-gray-400" : "text-gray-500"
                                      }`}
                                  >
                                  ...
                                  <p
                                    className={`text-sm flex items-center gap-2 ${darktheme ? "text-gray-400" : "text-gray-500"
                                      }`}
                                  >
                    ...
                    <div className="flex flex-col items-center mt-6">
                      ...
                      <h2
                        className={`text-xl font-bold ${darktheme ? "text-red-400" : "text-red-700"
                          }`}
                      >
              ...
              <div className="grid gap-4">
                {results.map((bus, idx) => (
                  <Card
                    key={idx}
                    className={`shadow-xl rounded-2xl cursor-pointer transition-all duration-300 hover:scale-[1.02] border ${darktheme
                  ...
                  >
                    <CardContent className="p-6 flex items-center gap-4">
                      <div
                        className={`w-14 h-14 rounded-xl flex items-center justify-center ${darktheme ? "bg-blue-500/20" : "bg-blue-100"
                          }`}
                      >
                      ...
                      <div className="flex-1">
                        <h2
                          className={`text-lg font-bold mb-1 ${darktheme ? "text-white" : "text-gray-800"
                            }`}
                        >
              ...
              results === null && (
                <div
                  className={`rounded-3xl shadow-2xl p-12 text-center border backdrop-blur-sm ${darktheme
                      ? "bg-gray-800/80 border-gray-700/50"
                      : "bg-white/90 border-white/50"
                    }`}
                >
                  <div className={`w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 ${darktheme ? 'bg-gray-700' : 'bg-gray-100'
                    }`}>
                    <Bus
                      className={`w-12 h-12 ${darktheme ? "text-gray-600" : "text-gray-400"
                        }`}
                    />
                  </div>
                  <h3
