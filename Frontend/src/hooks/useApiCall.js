...
export const useApiCall = ({
   ...
   */
  const extractSuccessMessage = useCallback((responseData) => {
    if (successMessage) {
  ...
  }, [apiFunction, onSuccess, onError, showSuccessToast, showErrorToast, extractSuccessMessage, extractErrorMessage]);
